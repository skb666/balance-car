...
/* OLED的管脚标号 */
#define OLED_DC_PORT	   3
#define OLED_DC_PIN	       3

#define OLED_RST_PORT      3
#define OLED_RST_PIN       6

#define OLED_DI_PORT	   3
#define OLED_DI_PIN	       5

#define OLED_CK_PORT	   3
#define OLED_CK_PIN	       4

#else

/* OLED的管脚标号 */
#define OLED_DC_PORT	   4
#define OLED_DC_PIN	       3

#define OLED_RST_PORT      4
#define OLED_RST_PIN       2

#define OLED_DI_PORT	   4
#define OLED_DI_PIN	       1

#define OLED_CK_PORT	   3
#define OLED_CK_PIN	       5

#endif

#define OLED_DC	    P(OLED_DC_PORT, OLED_DC_PIN)      /*!< OLED DC管脚 */ 
#define OLED_RST	P(OLED_RST_PORT, OLED_RST_PIN)    /*!< OLED RST管脚 */
#define OLED_DI	    P(OLED_DI_PORT, OLED_DI_PIN)      /*!< OLED DI管脚 */ 
#define OLED_CK	    P(OLED_CK_PORT, OLED_CK_PIN)      /*!< OLED CK管脚 */ 
...
/**
  ...
  * @note     无
  *
  * @example  lq_OLED_delayms(100);
  *
  * @date     2019/4/22 星期一
*/
static void lq_OLED_delayms(uint16_t ms)
{
	while(ms--)
	{
...
void OLED_Init(void)        
{ 
    PIN_InitPushPull(OLED_DC_PORT, OLED_DC_PIN);  
    PIN_InitPushPull(OLED_RST_PORT, OLED_RST_PIN); 
	PIN_InitPushPull(OLED_DI_PORT, OLED_DI_PIN);  
	PIN_InitPushPull(OLED_CK_PORT, OLED_CK_PIN);    
...
code uint8_t longqiu104x64[832] = {
...
{
    unsigned char xdata data1;  //data1当前点的数据 
...
{
    unsigned char xdata wm=0,ii = 0;
    unsigned int xdata adder=1; 
...
{ 	
    unsigned int xdata ii=0;
    unsigned char xdata x,y;
	unsigned char xdata x1,y1;
