...
/*!
  ...
  * @date     2019/6/13 星期四
  */
uint8_t FX_8700_GetACCRaw(int16_t *ax,int16_t *ay,int16_t *az)
{
...
/*!
  ...
  * @date     2019/6/13 星期四
  */
uint8_t FX_8700_GetMAGRaw(int16_t *mx,int16_t *my,int16_t *mz)
{
    uint8_t xdata buf[6],res;
...
{
    uint8_t xdata reg = FX_Read_Byte(FXOS8700_ADDR, FXOS8701CQ_XYZ_DATA_CFG);
...
/*!
  ...
  * @date     2019/6/13 星期四
  */
uint8_t FX_21002_GetRaw(int16_t * gyrox, int16_t *gyroy, int16_t *gyroz)
{
    uint8_t xdata buf[6],res;
...
{
    uint8_t xdata reg = FX_Read_Byte(FXAS21002C_ADDR, FXAS21002C_CTRL_REG1);
    if(enable)
    {
...
{
    uint8_t xdata reg = FX_Read_Byte(FXAS21002C_ADDR, FXAS21002C_CTRL_REG0);
